...
From an operations perspective, the field of retail store operations (Rsop in short)
...
basic supplies like electricity and tagging, handling point of sale (PoS) data.

Managing  Store  Operations

Sometimes when the scope of work is complex or large, like in large retail set-
...
Internet Retailing Atmospherics
...
Design element name and its description
...
and store space management. A brief overview of the important aspects of each of
...
How each of these elements is planned and executed can have a considerable impact
...
where markets were built several years ago,  when urban traffic was not very high,
...
1Clement, J. (2007). Visual influence on in-store buying decisions: an eye-track experiment on the
...
a very high number of buyers’ impressions are based on sight – meaning, what they
...
requirements, with customer needs playing the veto if needed.
...
Given that retailers undertake implementation of several processes on their space,
...
Space-to-sales ratio, turn rate and gross margin analysis can help create the most
...
will be to make it operationally manageable and make consumer movements across
...
the store easier and more conducive to locating items easily. Overall, Space allocation
...
to as a store’s physical characteristics that are used to evolve the retail store image,

214

and attract and retain customers. It has four key components - interior and exterior
...
The golden rule of sourcing is to buy quality merchandise at the most competitive price
...
self-constructed or following industry practice) that would have a set of evaluation
...
the vendor. Making sure the checklist is well addressed will help retailer to

220

make the best deal as well as have assurance regarding quality of the goods,
...
factors that determine which vendor(s) have high likelihood of selection. For each
...
Few  of  the  best  practices  to  manage  a  good  and  lasting  relationship  with
vendors are:
...
Include vendors in product development
...
retailer plans to strengthen vendor relationships in identified domains. Use the given
format.
...
generated by individual stores. The store generating maximum amount of sales will
...
the products they are looking for from the store. Thus, not having enough stock to

226

fulfill orders already taken by retailer for which payments are made can lead to
...
Improving cash flow: Locking too much cash into inventory at once means it’s
...
An inventory report gives vital information from the retailer’s point of view. A
...
1 Inventory shrinkage. An accounting term, it refers to inventory items that have been stolen,
...
2 Inventory turn over: Measures how many times your inventory is sold over a given time period
...
compute average inventory investment
...
3 Check: https://www.indianretailer.com/magazine/2008/july/Still- Nascent-RFID-application-in-
retail.m19-2-12

only 1250, then, ratio will be = 1250/1250 = 1.0 which means the average
...
for example should rarely (if ever) be out-of-stock and be given the highest priority
...
and focus. While C inventory may not warrant quite so much attention and items in this
...
% of total investment % of total profits
...
: The level of stocks at which the retailer will order for
...
: Reduction in stocks due to shoplifting, pilferage etc.
...
the function of purchasing goods from vendors for
further selling.

Sourcing and Inventory
Management

is strengthening of “buyer-vendor relationships” to
achieve mutually beneficial goals

: Using electronic platforms for transfer of data and
...
the vendor retains replenishment and maintenance
responsibilities for the inventory

Warehousing

: Receiving merchandise from vendors and storing them

safely

Stocking

: Storing safely of stocks to be sold ether in warehouse
...
the process of ordering, handling, storing, and using a
...
the reduction in inventory caused by shoplifting,
misplacement or damaging of merchandise.

is a form of wireless communication that incorporates
the use of electromagnetic or electrostatic coupling in
the radio frequency portion of the electromagnetic
spectrum to uniquely identify an object, animal or
person.

summarizes the inventory position at the level of SKUs.

Indicates how much the product was available when
asked by the customer on an average in a given time.

Reordering level

: The lower quantity of stocks availability at which a

new order is placed

Order Quantity

: The units of an SKU for which a purchase order needs

to be put

Sales Analysis

: Making investigations on sales already completed to
...
estimates the mean financial value (investment) or units
of an SKU or items in a category during two or more
specified periods.

Inventory Turnover
Ratio

: measures how many times your inventory is sold over

a given time period.

Sell Through Rate

: Compares amount of inventory a retailer receives with

what is actually sold over a given period.

Gross Margin Return on :
Investments or GMROI

ratio to measure the profitability of retailer’s inventory
over a given period.
...
: Helps to identify your most valuable inventory and
...
block 1 and 2 of this course. Among the extended Ps,physical evidence is already
...
covered in Unit 12 of block 3, and some parts of process management are covered in
...
1https://www.ibef.org/industry/retail-india

segmentation, targeting and positioning must be the foundation for the retail
mix decisions.
...
towards the organisation, but also to create the right brand image.
...
2. Create a healthy retail environment and cohesive team: The organization
...
and retaining people and placing them at the right place in the organisation. It is a sub-
...
comprehensiveness in understanding, appreciating the  people, skills, culture,
...
force. Active listening, empathy, and conducive culture to speak, are some of
...
2People managers must learn to activel y listen, maintain eye-contact, give verbal cues, and ask
questions to show that they are engaged with the employee.
...
3. Knowledge-Setting  and  Organization:  Workplaces  are  constantly
...
As  presented in figure 15.4, a typical retail manangment process in an organisaiton,
...
plans include some inputs on business process managements. Here we look at some
examples of process management in retail ecosystem:

1.

In Human Resource Department the process of Onboarding of New
...
1. Plan:The first stage in any process is called the planning. In retail management we
...
can say that the quality, designing and implementation of business processes is dependent
...
3. Reduced costs and risks: People play a key role in the success of any
...
a) Try to prepare a process flowchart for ‘conflict management’ among team
...
Thus CRM systems typically include a variety of tools and functionalities to manage
...
purchases. This information can help businesses to refine their marketing and sales
...
Improve Customer Experience: CRM systems are designed to help businesses
...
Increase Customer Retention: CRM systems allow businesses to build long-
...
service. This can help reduce costs and improve efficiency.
...
5. Gain Insights: By collecting and analyzing customer data, businesses can gain
...
Retailers are using CRM tactics to increase the value of their current consumers and
...
offer, and may not end up purchasing anything. In the long run, this customer costs the
...
tracking of employee data within a business, including contact details, performance

254

evaluations, and benefits. This makes it possible for the HR division to manage the
...
4. Managing clients successfully over the long term is necessary, given the competitive
...
For instance, if the retailer is aware of a customer who used their website to browse a
...
16.10 BENEFITS OF USING CRM SOFTWARE IN
...
retailer’s first interaction to the final email after closing the sale.

258

Nutshell enables sales managers and company leaders to precisely assess the state of
...
“Nutshell” enables search engine optimization (SEO) services to reach more high-
...
Zoho Sales Inbox. No matter what email a customer uses, SalesInbox arranges their
...
factors. Create a territory that automatically populates when new contacts are added
...
Integration: CRM systems often need to integrate with other business systems,
...
Privacy and security: CRM systems often contain sensitive customer data, such as
...
The role of CRM Affiliation in retailing includes the following:

1

Increasing customer loyalty: By offering additional products or services through
...
Improving customer experience: CRM Affiliation can improve the customer
...
categorizes profitable clients while promoting client satisfaction and loyalty. Both the
